...
{
    public class GTAVImporter : NeosMod
    {
        ...
        public static string cachePath = Path.Combine(Engine.Current.CachePath, "Cache", "Decompressed_GTA_Archives");
        ...
        private static ModConfigurationKey<bool> importAsRawFiles =
             ...
             "Import raw versions of GTA files into Neos",
             () => false);
        [AutoRegisterConfigKey]
        ...
        public override void OnEngineInit()
        {
            ...
            Engine.Current.RunPostInit(() => AssetPatch(customFileExtensions));
        }

        private static void AssetPatch(string[] fileExtensions)
        {
